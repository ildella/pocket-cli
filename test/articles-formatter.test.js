...
test('format', () => {
  const entry = {
    ...
    title: 'something something dark side, and a lot of useless bla bla in this very very long title that is going to be cut.',
  ...
  expect(formattedText[0]).toContain('something something dark side,')
  expect(formattedText[0]).not.toContain('going to be cut')
})
